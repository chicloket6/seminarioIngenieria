...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('metodopago') }}'><i class='nav-icon fa fa-question'></i> MetodoPagos</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('habitacion') }}'><i class='nav-icon fa fa-question'></i> Habitacions</a></li>